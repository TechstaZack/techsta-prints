...
function fidTriUpdated(){
    ...
    .then(data => {
        ...
        if(price < 100){
            ...
            price = price / 100
            price = `$${price}`
            if(price.includes('.') && !price.endsWith('0')) {
                price = `${price}0`
            }else{
                price = `${price}.00`
            }
    ...
    document.getElementById('productModal').innerHTML = `<div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer" style='object-position: center;'>
            <button class="btn btn-outline-secondary" id="addtocart" onclick="triaddtocart()">Add To Cart <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
